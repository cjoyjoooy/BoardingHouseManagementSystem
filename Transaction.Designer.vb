...
Partial Class Transaction
    ...
    Private Sub InitializeComponent()
        ...
        txtSearchTransaction.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        txtSearchTransaction.Font = New Font("Arial Rounded MT Bold", 12F, FontStyle.Regular, GraphicsUnit.Point)
        txtSearchTransaction.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
