...
Partial Class Tenant
    ...
    Private Sub InitializeComponent()
        ...
        lblTenantDateLeased = New Label()
        lblTenantRoom = New Label()
        lblTenantStatus = New Label()
        lblTenantContact = New Label()
        lblTenantAddress = New Label()
        lblTenantGender = New Label()
        ...
        Guna2Panel2.Controls.Add(lblTenantDateLeased)
        Guna2Panel2.Controls.Add(lblTenantRoom)
        Guna2Panel2.Controls.Add(lblTenantStatus)
        Guna2Panel2.Controls.Add(lblTenantContact)
        Guna2Panel2.Controls.Add(lblTenantAddress)
        Guna2Panel2.Controls.Add(lblTenantGender)
        Guna2Panel2.Controls.Add(lblTenantName)
        ...
        Guna2Panel2.Location = New Point(11, 423)
        Guna2Panel2.Name = "Guna2Panel2"
        Guna2Panel2.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        Guna2Panel2.Size = New Size(411, 261)
        ...
        lblTenantDateLeased.Size = New Size(26, 26)
        lblTenantDateLeased.TabIndex = 36
        lblTenantDateLeased.Text = "--"
        ' 
        ' lblTenantRoom
        ' 
        ...
        lblTenantRoom.Size = New Size(26, 26)
        lblTenantRoom.TabIndex = 35
        lblTenantRoom.Text = "--"
        ' 
        ' lblTenantStatus
        ' 
        ...
        lblTenantStatus.Size = New Size(26, 26)
        lblTenantStatus.TabIndex = 34
        lblTenantStatus.Text = "--"
        ' 
        ' lblTenantContact
        ' 
        ...
        lblTenantContact.Size = New Size(26, 26)
        lblTenantContact.TabIndex = 33
        lblTenantContact.Text = "--"
        ' 
        ' lblTenantAddress
        ' 
        ...
        lblTenantAddress.Size = New Size(26, 26)
        lblTenantAddress.TabIndex = 32
        lblTenantAddress.Text = "--"
        ' 
        ' lblTenantGender
        ' 
        ...
        lblTenantGender.Size = New Size(26, 26)
        lblTenantGender.TabIndex = 31
        lblTenantGender.Text = "--"
        ' 
        ' lblTenantName
        ' 
        ...
        Guna2Panel4.Controls.Add(lblLastPayment)
        Guna2Panel4.Controls.Add(Label16)
        Guna2Panel4.Controls.Add(lblAmountDue)
        ...
        lblAmountDue.Size = New Size(26, 26)
        lblAmountDue.TabIndex = 23
        lblAmountDue.Text = "--"
        ' 
        ' Label10
        ' 
        ...
        dgvTenant.Location = New Point(11, 47)
    ...
    Friend WithEvents lblTenantDateLeased As Label
    Friend WithEvents lblTenantRoom As Label
    Friend WithEvents lblTenantStatus As Label
    Friend WithEvents lblTenantContact As Label
    Friend WithEvents lblTenantAddress As Label
    Friend WithEvents lblTenantGender As Label
    Friend WithEvents lblLastPayment As Label
End Class
