...
Partial Class Home
    ...
    Private Sub InitializeComponent()
        ...
        btnTenant = New Guna.UI2.WinForms.Guna2Button()
        btnDashboard = New Guna.UI2.WinForms.Guna2Button()
        Label1 = New Label()
        btnRoom = New Guna.UI2.WinForms.Guna2Button()
        ...
        Guna2Panel1.Controls.Add(btnTenant)
        ...
        panelHome.BackColor = Color.FromArgb(CByte(232), CByte(232), CByte(231))
        ...
        ' btnTenant
        ' 
        btnTenant.Animated = True
        btnTenant.AutoRoundedCorners = True
        btnTenant.BorderRadius = 27
        ...
        btnTenant.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnTenant.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnTenant.FillColor = Color.FromArgb(CByte(27), CByte(27), CByte(27))
        ...
        btnTenant.TabIndex = 6
        btnTenant.Text = "Tenant"
        btnTenant.TextOffset = New Point(-18, 0)
        ' 
        ' btnDashboard
        ' 
        btnDashboard.Animated = True
        btnDashboard.AutoRoundedCorners = True
        btnDashboard.BorderColor = Color.Empty
        btnDashboard.BorderRadius = 27
        ...
        btnDashboard.FillColor = Color.FromArgb(CByte(27), CByte(27), CByte(27))
        ...
        btnRoom.AutoRoundedCorners = True
        btnRoom.BorderRadius = 27
        ...
        btnRoom.DisabledState.FillColor = Color.FromArgb(CByte(169), CByte(169), CByte(169))
        btnRoom.DisabledState.ForeColor = Color.FromArgb(CByte(141), CByte(141), CByte(141))
        btnRoom.FillColor = Color.FromArgb(CByte(27), CByte(27), CByte(27))
        ...
        btnTransaction.AutoRoundedCorners = True
        btnTransaction.BorderRadius = 27
        ...
        btnTransaction.FillColor = Color.FromArgb(CByte(27), CByte(27), CByte(27))
        ...
        btnLogout.FillColor = Color.FromArgb(CByte(27), CByte(27), CByte(27))
        ...
        btnLogout.TextOffset = New Point(-18, 0)
        ' 
        ' Home
        ' 
    ...
    Friend WithEvents btnTenant As Guna.UI2.WinForms.Guna2Button
